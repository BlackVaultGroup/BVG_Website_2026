...
const WHY_PARAGRAPHS = [
  "Because the businesses that win the next decade will not necessarily be the ones with the biggest teams. They will be the ones with the best systems. Our goal is to make that level of operational leverage available to businesses that could never justify an in-house automation team.",
