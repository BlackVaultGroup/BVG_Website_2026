...
const PARAGRAPHS = [
  "BlackVault Group was founded by Aidan and Karsten, two operators who believe small and mid-size businesses deserve the same operational infrastructure that large companies take for granted. Before opening our doors to the public, we spent years building behind the scenes — designing the systems and automations that quietly power growing companies.",
  "Our work has taken us across industries and borders. We have built and scaled operations for multiple private companies in Arizona, Dubai, and other international markets — marketing and media firms, hospitality and real estate ventures, consumer brands, and companies in the robotics industry. Different industries, same pattern: growth stalls wherever operations cannot keep up. Leads go cold waiting for a reply. Owners spend their evenings on work a system should be doing.",
